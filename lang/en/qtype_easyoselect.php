...
/**
 * Strings for component 'qtype_easyoselect', language 'en', branch 'MOODLE_20_STABLE'
 *
 * @package    qtype
...
$string['easyoselect_options'] = 'Marvin Applet options';
...
$string['configeasyoselectoptions'] = 'Comma separated list of Marvinsketch applet options (see <a href="http://www.chemaxon.com">list of available options</a>)';
