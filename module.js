...
*
*/
M.qtype_easyoselect.init_showarrows = function(Y, moodle_version, slot){
	...
	document.getElementById('curarrow'+slot).value=Number(currentarrow);
		...
		xAll = xmlDoc.getElementsByTagName('*');
			...
			document.getElementById('EASYOSELECT'+slot).setMol(newxmlStr, "mrv");
...
M.qtype_easyoselect.init_showarrowsrev = function(Y, moodle_version, slot){
    var handleSuccess = function(o) {
